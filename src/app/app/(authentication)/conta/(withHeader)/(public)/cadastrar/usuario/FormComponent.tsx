...
<<<<<<<< HEAD:src/app/(app)/(authentication)/conta/(withHeader)/(public)/cadastrar/usuario/FormComponent.tsx
...
========
            .then(() => router.push((callbackUrl as Route) ?? "/app/"))
>>>>>>>> 5b7cfa46f47cdbe78d6dea0e12e4f5384af5753b:src/app/app/(authentication)/conta/(withHeader)/(public)/cadastrar/usuario/FormComponent.tsx
            .catch((error) => {
              showToastify({
                label:
