...
function ImageSizeWarning({
  ...
  return (
    <div className="p-4 bg-[#6722ff0d] rounded-lg flex flex-row justify-between flex-grow">
      <div>
      ...
      <div className="flex justify-center items-center w-1/2">
        <div className="flex gap-2 items-center w-1/2">
          <Image src={WidthIcon} width={24} height={24} alt={"width icon"} />
          <p className="text-primary-main">{recommendedWidth} px</p>
        </div>
        <div className="flex gap-2 items-center w-1/2">
          <Image src={HeigthIcon} width={24} height={24} alt={"heigth icon"} />
