...
const SwitchDarkMode: React.FC<SwitchDarkModeProps> = ({ className = "" }) => {
  ...
  return (
    <button
      ...
      className={`text-2xl md:text-3xl w-12 h-12 rounded-full text-neutral-700  hover:bg-neutral-100  focus:outline-none flex items-center justify-center ${className}`}
    >
