  ...
  return (
    <div className='min-h-[75vh] w-full flex flex-col text-black'>
      ...
      <div className='flex flex-col gap-4 mb-4 items-center'>
        ...
        <p className='rounded-full uppercase text-white text-2xl font-semibold px-4 py-2 bg-generic-dark'>{id}</p>
      </div>
      <div className='flex items-center justify-between mb-2 gap-3'>
      <hr className="border-slate-200 w-full"></hr>
      <p className='w-full text-generic-alertGreen font-semibold text-base
      '>Cupom ativo</p>
      <hr className="border-slate-200 w-full"></hr>
      </div>
      <div className='flex flex-col h-auto'>
        <div className='flex item-center'>
          <Image className='w-16 h-16 rounded-full' src={supplierLogo} alt='supplier-logo' />
        ...
        <AccordionInfo data={[{ name: "Regras de uso", content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa," }]}></AccordionInfo>
      </div>
    </div>
  )
}
