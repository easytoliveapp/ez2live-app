        ...
        <Transition appear show={isOpenMoreFilter} as={Fragment}>
          ...
          >
            <div className="min-h-screen text-center">
              ...
              >
                <div className="inline-flex flex-col w-full text-left align-middle transition-all transform bg-white h-full">
                  ...
                  <div className="flex-grow overflow-y-auto">
                    <div className="px-6 sm:px-8 md:px-10 divide-y divide-neutral-200 ">
                      {/* --------- */}
                      {/* ---- */}
                      <div className="py-7">
